...
do local GUI = game.CoreGui:FindFirstChild("Darkrai");if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(147, 255, 204)
   end 
end
...
function DarkraiX:Window(text,gamenme,logo,keybind)
	...
	Name.Text = hubname
	Name.TextColor3 = Color3.fromRGB(147, 255, 204)
	...
	Hub.Text = "  | "..gamename
	Hub.TextColor3 = Color3.fromRGB(147, 255, 204)
	Hub.TextSize = 17.000
	...
	function uitab:Tab(text)
	    ...
	    TabButton.BorderColor3 = Color3.fromRGB(147, 255, 204)
